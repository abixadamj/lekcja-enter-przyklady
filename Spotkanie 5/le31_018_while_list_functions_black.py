...
# używamy formattera black -> https://github.com/psf/black
...
def dodaj_osobe():
    zaproszona_osoba = input("Podaj imię zapraszanej osoby (NIE - nie doda): ")
    if zaproszona_osoba == "NIE":
        pass
    else:
...
def wyszukaj_osobe():
    osoba = input("Podaj imię szukanej osoby: ")
    if osoba in lista_znajomych:
        print(f"TAK - {osoba} jest na liście.")
    else:
        print(f"NIE - {osoba} nie ma na liście.")
        dodaj_osobe()
